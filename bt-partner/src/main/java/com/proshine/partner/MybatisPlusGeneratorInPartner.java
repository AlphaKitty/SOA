...
/**
 * ClassName: MybatisPlusGeneratorInPartner
 * Description: mybatis-plus 代码生成
 * Author: zyl
 * Date: 2019/9/19 17:27
 */
public class MybatisPlusGeneratorInPartner {
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.proshine.partner");
