...
/**
 * ClassName: MybatisPlusGeneratorInTerminal
 * Description: 中间件MP生成器
 * Author: zyl
 * Date: 2019/9/19 17:27
 */
public class MybatisPlusGeneratorInTerminal {
    ...
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.proshine.terminal");
