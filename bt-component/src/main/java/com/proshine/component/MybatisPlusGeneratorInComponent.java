...
/**
 * ClassName: MybatisPlusGeneratorInComponent
 * Description: mybatis-plus 代码生成
 * Author: zyl
 * Date: 2019/9/19 17:27
 */
public class MybatisPlusGeneratorInComponent {
    ...
    public static void main(String[] args) {
        ...
        String modulePath = "/bt-component";
        ...
        packageConfig.setParent("com.proshine.component");
